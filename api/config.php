...
$host = "teclab.uct.cl"; // Host de la base de datos
$db = "marco_sandoval_db2"; // Nombre de la base de datos
$user = "marco_sandoval"; // Usuario de la base de datos
$pass = "marco_sandoval2025"; // Contraseña de la base de datos
